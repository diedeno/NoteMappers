...
MuseScore {
    version: "0.92"
    description: "Adaptive -- This plugin applies a map originating from any of the following NoteMapper plugins: Map Assistant, Note to Note, Pc to Pc, Pitch to Pitch"
    pluginType: "dialog"
    //thumbnailName: "something.png";
    categoryCode: "composing-arranging-tools"
    title: "Notemapper-Adaptive"
...
// ================================================================ DIALOGS
    ...
    Dialog {
        ...
        visible: false
        title: "NoteMapper - Adaptive Mapper: Map Input"
        standardButtons: Dialog.Help | Dialog.Apply | Dialog.Cancel
...
// =========== help dialog
    ...
    Dialog {
        ...
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "NoteMapper - Adaptive Mapper: Help"
        visible: false
