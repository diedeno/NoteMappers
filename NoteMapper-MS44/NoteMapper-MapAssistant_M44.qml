...
// 
//  v0.91 (C) 2023 Diego Denolf, port to MuseScore 4
//  v0.92 (C) 2023 Diego Denolf, port to MuseScore Studio 4.4 (Qt6.2)
//
...
MuseScore {
    version: "0.92"
    description: "This plugin reads two staves of single notes and builds a map that sends the 1st note of the upper staff to the 1st of the lower, the 2nd of the upper to the 2nd of the lower, 3rd to 3rd, and so on. Maps can be configured for use in the Note to Note, Pc to Pc, Pitch to Pitch, or Adaptive NoteMapper plugins. "
    pluginType: "dialog"
    // thumbnailName: "thumbnail.png";
    categoryCode: "composing-arranging-tools"
    title: "Notemapper Map Assistant"
...
// =========== confirmScore dialog
    ...
    Dialog {
        ...
        width: 750
        height: 500
        palette.buttonText: "orangered"
        palette.text: "orangered"
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "Notemapper - Map Assistant: Please Confirm"
        visible: false
...
//=========
    ...
    Dialog {
        ...
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "NoteMapper Map Assistant: Choose map type"
        visible: false
        standardButtons: Dialog.Help | Dialog.Cancel | Dialog.Ok

        
        onHelpRequested: helpDialog.open(); // this closes getMapType dialog on most platforms
        ...
        Rectangle {
            ...
            Grid {
               ...
               // ExclusiveGroup { //here is no ExclusiveGroup in QtQuick.Controls 2 
               ButtonGroup {
                    id: mapTypeGroup
                }
                RadioButton {
       ...
       //         }
        ...
        Text {
            ...
            anchors.topMargin: 20
            anchors.leftMargin: 20
            text: "Map Assistant will build a map based on notes in the current score.<br />"
...
// =========== help dialog
    ...
    Dialog {
        ...
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "NoteMapper - Map Assistant: Help"
        visible: false
...
//=========
    Dialog {
        ...
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "Notemappers - Map Assistant: Result"
        visible: false
        standardButtons: Dialog.Cancel	// A Close button defined with the RejectRole. replaced with Cancel
