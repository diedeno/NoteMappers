...
// ================================================================ DIALOGS
    ...
    Dialog {
        ...
        visible: false
        title: "NoteMapper Note to Note: Map Input"
...
// addMappingArea
        ...
        ComboBox {
            id: cbFromLetter
            //: ComboBoxStyle { font.family: "FreeSerif"; font.pointSize: fSize } // nice accidentals
...
// =========== help dialog
    ...
    Dialog {
        ...
        palette.windowText: "black"
        palette.active.window: "whitesmoke"
        title: "NoteMapper Note to Note: Help"
        visible: false
