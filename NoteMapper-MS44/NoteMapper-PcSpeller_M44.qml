...
MuseScore {
    version: "0.92"
    description: "This plugin applies a user-specified spelling to each pitch class, with an option to show accidentals explicitly on every note."
    pluginType: "dialog"
    // thumbnailName: "thumbnail.png"
    categoryCode: "composing-arranging-tools"
    title: "Notemapper-PCSpeller"
   ...
   //property var ebony: "#282C34"
   // property var ivory: "#CCCCCC"
   property var ivory: "#fffff0"
...
// ================================================================ DIALOGS
    ...
    Dialog {
        ...
        visible: false
        title: "NoteMappers - Pitch Class Speller: Map Input"
